...
assert.match(markup, /mealContext\.title/)
assert.match(markup, /mealContext\.title/)
...
assert.match(script, /localTime/)
assert.match(script, /reuseContext/)
assert.match(script, /recommendationTitle/)
assert.match(script, /const mealContext = coachResult\.mealContext \|\|/)
assert.match(script, /name:\s*'dailyRecords'/)
